...
async def handle_message(update: Update, context: CallbackContext) -> None:
    ...
    if 'ticket_generated' in context.user_data:
        ...
        if user_id in contacts:
            ...
            if user_name == "User not found":
                ...
                await update.message.reply_text(f"Welcome back, {user_name}. What would you like to do?")
                ...
                reply_markup = InlineKeyboardMarkup(keyboard)
                await update.message.reply_text(f"What would you like to do?", reply_markup=reply_markup)
                button_shown[user_id] = True
        else:
